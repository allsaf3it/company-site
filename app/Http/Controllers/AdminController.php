...
class AdminController extends Controller
{
    ...
    public function admin(){
        ...
        $inspiros = Inspiro::count();
        $messages = ContactUs::count();
        $courses = Course::count();
        $categories = Category::count();
        
        return view('admin.index',compact('services','brands','projects','users','galleryImages','blogs','messages','categories', 'testimonials', 'courses', 'inspiros'));
    }
