...
class IntroSliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            $path = base_path('uploads/sliders/intro-sliders/source/' . $fileName);
            $resize200 = base_path('uploads/sliders/intro-sliders/resize200/' . $fileName);
            $resize800 = base_path('uploads/sliders/intro-sliders/resize800/' . $fileName);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            $img_path = base_path() . '/uploads/sliders/intro-sliders/source/';
            $img_path200 = base_path() . '/uploads/sliders/intro-sliders/resize200/';
            $img_path800 = base_path() . '/uploads/sliders/intro-sliders/resize800/';
