        ...
        <div class="cb-tophead-content">
            <div class="cb-tophead-container">
                ...
                <div class="cb-tophead-title">
                    <h2>{!! app()->getLocale() == 'en' ? $project->title_en_inside : $project->title_ar_inside !!}</h2>
                </div>
            </div>
        </div>
    </header>
    <section class="cb-screenshot">
        <div class="cb-screenshot-preview -lg"><img src="{{url('uploads/projects/source/' . $project->image2)}}" alt>
        </div>
    </section>
            ...
            <div class="cb-brief-container">
                <div class="cb-brief-grid">
                    ...
                    <div class="cb-brief-grid-col -right">
                        ...
                        ?>
                        <div class="cb-brief-link">@foreach($challengeArr as $challengeItem){!! $challengeItem !!}@endforeach</div>
                    </div>
                </div>
            </div>
        </div>
