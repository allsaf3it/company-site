                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2" name="lang" required>
                                        <option value="en" @if($aboutStruc->lang == 'en') selected @endif>{{trans('home.english')}}</option>
                                        <option value="ar" @if($aboutStruc->lang == 'ar') selected @endif>{{trans('home.arabic')}}</option>
                                    </select>
                                </div>
