                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method'=>'PATCH','url' => 'admin/settings/'.$settings->id, 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="">{{trans('home.github')}}</label>
                                    <input type="github"  min="0" class="form-control" placeholder="{{trans('home.github')}}" name="github" value="{{ $settings->github }}">
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    <label class="">{{trans('home.behance')}}</label>
                                    <input type="text"  min="0" class="form-control" placeholder="{{trans('home.behance')}}" name="behance" value="{{ $settings->behance }}">
                                </div>

                                
                                <div class="form-group col-md-3">
                                    <label for="dribbble">{{trans('home.dribbble')}}</label>
                                    <input type="text"  class="form-control" placeholder="{{trans('home.dribbble')}}" name="dribbble" value="{{ $settings->dribbble }}">
                                </div>
