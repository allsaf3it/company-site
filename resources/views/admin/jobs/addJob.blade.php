...
<title>{{trans('home.add_job')}}</title>
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_job')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.add_job')}}</h6>
                        </div>
                        {!! Form::open(['route' => 'jobs.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="time" type="text" placeholder="{{trans('home.time')}}" >
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="">{{trans('home.location')}}</label>
                                    <input class="form-control" name="location" type="text" placeholder="{{trans('home.location')}}">
                                </div>
