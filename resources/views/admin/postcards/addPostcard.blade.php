...
<title>{{trans('home.add_postcard')}}</title>
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_postcard')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.add_postcard')}}</h6>
                        </div>
                        {!! Form::open(['route' => 'postcards.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 area1">    
                                    <fieldset class="form-group">
                                        ...
                                        <textarea class="form-control area1" placeholder="{{trans('home.text_en')}}" name="text_en"></textarea>
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-6 area1">    
                                    <fieldset class="form-group">
                                        <label for="text_ar">{{trans('home.text_ar')}}</label>
                                        <textarea class="form-control area1" placeholder="{{trans('home.text_ar')}}" name="text_ar"></textarea>
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-6 ">    
                                    <fieldset class="form-group">
                                        <label for="details_en">{{trans('home.details_en')}}</label>
                                        <textarea class="form-control area1" placeholder="{{trans('home.details_en')}}" name="details_en"></textarea>
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-6 ">    
                                    <fieldset class="form-group">
                                        <label for="details_ar">{{trans('home.details_ar')}}</label>
                                        <textarea class="form-control area1" placeholder="{{trans('home.details_ar')}}" name="details_ar"></textarea>
                                    </fieldset>
                                </div>
