						...
						<div class="main-content-body main-content-body-contacts">
							...
							<div class="main-contact-info-body">
								...
								<div class="media-list">
									<div class="media">
										<div class="media-body">
											...
											<div>
												<label>{{trans('home.budget')}}</label> <span class="tx-medium">{{$contactUsMessage->budget}}</span>
											</div>
											<div>
								...
								<div class="media-list">
									<div class="media">
										<div class="media-body">
										    @if($contactUsMessage->attachments))
												<div>
													<a href="{{url('uploads/forms/'.$contactUsMessage->attachments)}}" target="_blank">
														{{trans('home.attachment')}}</a>
												</div>
											@endif
								            @if($contactUsMessage->attachments))
											<div>
												<label>{{trans('home.attachment')}}</label> 
												<img src="{{url('uploads/forms/'.$contactUsMessage->attachments)}}">
											</div>
											@endif
										</div>
