        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_achievement')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.add_achievement')}}</h6>
                        </div>
                        {!! Form::open(['route' => 'achievements.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                <div class="form-group col-md-6 area1">    
                                    <fieldset class="form-group">
                                        <label for="title_en">{{trans('home.title_en')}}</label>
                                        <textarea class="form-control area1" placeholder="{{trans('home.title_en')}}" name="title_en"></textarea>
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-6 area1">    
                                    <fieldset class="form-group">
                                        <label for="title_ar">{{trans('home.title_ar')}}</label>
                                        <textarea class="form-control area1" placeholder="{{trans('home.title_ar')}}" name="title_ar"></textarea>
                                    </fieldset>
                                </div>
