...
<title>{{trans('home.edit_brandreel')}}</title>
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.edit_brandreel')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.edit_brandreel')}}</h6>
                        </div>
                        {!! Form::open(['method'=>'PATCH','url' => 'admin/brandsreel/'.$brand->id, 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                @if($brand->logo)
                                    <div class="col-md-12">
                                        <img src="{{url('\uploads\brandsreel\source')}}\{{$brand->logo}}" width="150">
                                    </div>
                                @endif
