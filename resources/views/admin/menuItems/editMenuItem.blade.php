                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="form-group col-md-4"> 
                                            ...
                                            <select class="form-control select2 menu_type" name="menu_type" required>
                                                ...
                                                <option value="what-we-do" {{($menuItem->type == 'home')?'selected':''}}>{{trans('home.home')}}</option>
                                                ...
                                                <option value="courses" {{($menuItem->type == 'courses')?'selected':''}}>{{trans('home.courses')}}</option>
                                                <option value="career" {{($menuItem->type == 'careers')?'selected':''}}>{{trans('home.careers')}}</option>
                                                ...
                                                <option value="hello" {{($menuItem->type == 'hello')?'selected':''}}>{{trans('home.hello')}}</option>
                                                <option value="security-plans" {{($menuItem->type == 'security-plans')?'selected':''}}>{{ __('Security Plans') }}</option>
