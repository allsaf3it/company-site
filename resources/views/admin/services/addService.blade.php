                        ...
                        {!! Form::open(['route' => 'services.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_en')}}" name="name_service_en" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="name_service_ar">{{trans('home.name_ar')}}</label>
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_ar')}}" name="name_service_ar">
                                </div>
                                <div class="col-md-4">
...
@section('script')
    <script>
         $(document).ready(function(){
            ...
            fieldHTML +='<div class="form-group col-md-12"><label for="answer">{{trans('home.answer')}}</label><textarea class="form-control" placeholder="{{trans('home.answer')}}" name="answer[]"></textarea></div>';
