                            ...
                            <tbody>
                                @foreach($services as $service)
                                    <tr id="{{$service->id}}">
                                        ...
                                        <td><a href="{{ route('services.edit', $service->id) }}">{{$service->name_service_en}}</a></td>
                                        <td><a href="{{ route('services.edit', $service->id) }}">{{$service->name_service_ar}}</a></td>
                                        <td>
                                        ...
                                        <td><a href="{{app()->getLocale() == 'en' ? LaravelLocalization::localizeUrl('service/'.$service->link_en) : LaravelLocalization::localizeUrl('service/'.$service->link_ar) }}" target="_blank"><i class="fas fa-eye"></i> {{trans('home.service_preview')}}</a></td>
                                    </tr>
