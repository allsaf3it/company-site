                        ...
                        {!! Form::open(['method'=>'PATCH','url' => 'admin/services/'.$service->id, 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_en')}}" name="link_en" value="{{$service->link_en}}" required>
                                </div>

                                <div class="form-group col-md-3">
                                    <label for="name_ar">{{trans('home.slug_ar')}}</label>
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_ar')}}" name="link_ar" value="{{$service->link_ar}}" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="name_service_en">{{trans('home.name_en')}}</label>
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_en')}}" name="name_service_en" value="{{$service->name_service_en}}" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="name_service_ar">{{trans('home.name_ar')}}</label>
                                    <input type="text"  class="form-control" placeholder="{{trans('home.name_ar')}}" name="name_service_ar" value="{{$service->name_service_ar}}">
                                </div>
                                <div class="col-md-4">
                                        ...
                                        @if($service->video)
                                            <div class="form-group col-md-3">
                                                <video preload="auto" loop muted autoplay playsinline width="100%" height="190px">
                                                    <source src="{{url('uploads/services/source/' . $service->video)}}" type="video/mp4">
                                                </video>
                                            </div>
                                        @endif
                                        @if($service->img)
                                ...
                                <!--        <textarea class="form-control " name="meta_keywords_en" placeholder="{{trans('home.meta_keywords_en')}}" >{{$service->meta_keywords_en}}</textarea>-->
                                <!--</div>-->
                                <!--<div class="form-group col-md-6 ">-->
                                <!--        <label for="blogcategory">{{trans('home.meta_keywords_ar')}}</label>-->
                                <!--        <textarea class="form-control " name="meta_keywords_ar" placeholder="{{trans('home.meta_keywords_ar')}}" >{{$service->meta_keywords_ar}}</textarea>-->
                                <!--</div>-->

                                <!--<div class="form-group col-md-6 "> -->
                                <!--    <label for="meta_descriptions_en">{{trans('home.meta_descriptions_en')}}</label>-->
                                <!--    <textarea class="form-control " name="meta_descriptions_en" placeholder="{{trans('home.meta_descriptions_en')}}" >{{$service->meta_descriptions_en}}</textarea>-->
                                <!--</div>-->
                                <!--<div class="form-group col-md-6 "> -->
                                <!--    <label for="meta_descriptions_ar">{{trans('home.meta_descriptions_ar')}}</label>-->
                                <!--    <textarea class="form-control " name="meta_descriptions_ar" placeholder="{{trans('home.meta_descriptions_ar')}}" >{{$service->meta_descriptions_ar}}</textarea>-->
                                <!--</div>-->
