                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control select2" name="lang" required>
                                        <option value="en" @if($testimonial->lang == 'en') selected @endif>{{trans('home.english')}}</option>
                                        <option value="ar" @if($testimonial->lang == 'ar') selected @endif>{{trans('home.arabic')}}</option>
                                    </select>
                                </div>
