                            ...
                            <tbody>
                                @foreach($testimonials as $testimonial)
                                    <tr id="{{$testimonial->id}}">
                                        ...
                                        <td><a href="{{ route('testimonials.edit', $testimonial->id) }}">{{$testimonial->lang}}</a></td>
                                        <td><a href="{{ route('testimonials.edit', $testimonial->id) }}">@if($testimonial->status == 1) {{trans('home.yes')}} @else  {{trans('home.no')}} @endif</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
