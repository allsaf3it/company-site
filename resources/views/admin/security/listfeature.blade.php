                            ...
                            <tbody>
                                @foreach($feature as $item)
                                    <tr id="{{$item->id}}">
                                        ...
                                        <td>
                                            <a href="{{ route('editfeature', $item->id) }}">
                                                {{ $item->title_en }}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td><a href="{{ route('editfeature', $item->id) }}">@if($item->status == 1) {{trans('home.yes')}} @else  {{trans('home.no')}} @endif</a></td>
                                        <td>
                                            <a href="{{ route('moredetails' , $item->id) }}" class="btn btn-success" >More Details</a>
                                            <a href="{{ route('deletefeature' , $item->id) }}" class="btn btn-danger" >{{trans('home.delete')}}</a>
                                        </td>
                                    </tr>
