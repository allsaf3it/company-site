                            ...
                            <tbody>
                                @foreach($staticsection as $item)
                                    <tr id="{{$item->id}}">
                                        ...
                                        <td><a href="{{ route('edittatics', $item->id) }}">@if($item->status == 1) {{trans('home.yes')}} @else  {{trans('home.no')}} @endif</a></td>
                                        <td><a href="{{ route('deletetatics' , $item->id) }}" class="btn btn-danger" >{{trans('home.delete')}}</a></td>
                                    </tr>
