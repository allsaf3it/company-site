document.getElementById("table-gridjs") &&
  ...
  document.getElementById("table-card") &&
    new gridjs.Grid({
        ...
        { name: "Percentage", width: "150px" },
        { name: "Date", width: "150px" },
        { name: "Profit_Per", width: "150px" },
        { name: "Profit_USDT", width: "150px" },
        { name: "Side", width: "150px" },
        { name: "Quantity", width: "150px" },
        { name: "Price", width: "150px" },
        { name: "Status", width: "150px",
            formatter: ()=> {
                return gridjs.html(
                    `
                        <span class="text-success fs-15 mb-0">
                            Open
                        </span>
                    `
                )
        ...
        data: [
          bots.forEach(()=> {
            [
              "0.02718", "07 Oct, 2021", "0.3754", "0", "+29.08", "Open",
            ]
          })
  ...
  document.getElementById("table-pagination") &&
    new gridjs.Grid({
      columns: [
        ...
        { name: "Purchasing Price", width: "150px" },
        { name: "Date", width: "180px" },
        { name: "Current Price", width: "120px" },
