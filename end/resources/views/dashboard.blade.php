                                        ...
                                        <div class="card-body">
                                            <form method="post" action="{{route('user.profile.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <img id="showImages" src="{{ !empty($userData->photo) ? url('uploads/user_images/' . $userData->photo) : url('uploads/no_image.jpg')}}" alt="User" class="rounded-circle p-1 bg-primary" width="110" />
                                                    </div>
                                                    <div class="col-md-12">
                                            ...
                                            <form method="post" action="{{route('user.update.password')}}">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input class="form-control @error('old_password') is-invalid @enderror" name="old_password" type="password" id="current_password" placeholder="Old Paswword"  />
                                                        @error('old_password')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input class="form-control @error('new_password') is-invalid @enderror" name="new_password" type="password" id="new_password" placeholder="New Paswword" />
                                                        @error('new_password')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
