        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{route('store.dashboardMenuitem')}}">
                            @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <select class="form-select mb-3" aria-label="Default select example" name="type" required>
                                            ...
                                            <option value="javascript:;">{{trans('home.parent')}}</option>
                                            <option value="my-bots">{{trans('home.my-bots')}}</option>
                                            <option value="recommendation">{{trans('home.recommendation')}}</option>
                                            <option value="my-wallet">{{trans('home.my-wallet')}}</option>
                                            <option value="medium-term">{{trans('home.medium-term')}}</option>
                                            <option value="long-term">{{trans('home.long-term')}}</option>
                                            <option value="packages">{{trans('home.packages')}}</option>
                                            <option value="st-wallet">{{trans('home.st-wallet')}}</option>
                                            <option value="invite-friends">{{trans('home.invite-friends')}}</option>
                                            <option value="deposite">{{trans('home.deposite')}}</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" class="form-control"  placeholder="{{trans('home.font_awsome')}}" name="font_awsome" />
                                    </div>
                                </div>
