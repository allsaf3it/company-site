        ...
        @if(count($longTerm) > 0)
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <h1 class="card-title fs-36 mb-0">{{trans('home.Long Term')}}</h1>
                                </div>
            ...
            <div class="row mt-lg-5 mt-md-3 mt-sm-3 mt-3">
                <div class="col-12 mb-3">
                    <div class="card-body">
                        <div class="d-flex">
                            <form class="col-12 mb-3" method="get" action="{{LaravelLocalization::localizeUrl('dashboard/search-long-term')}}">
                ...
                @foreach($longTerm as $longTermItem)
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 ms-3">
                                        <h3 class="text-uppercase fw-medium text-white mb-3">{{$longTermItem->ticker}}</h3>
                                        ...
                                        <h4 class="text-capitalize fw-medium mb-1 fs-14">{{$longTermItem->updated_at}}</h4>
                                    </div>
                                ...
                                <div class="px-2 py-2 mt-1">
                                    <p class="mb-1">{{trans('home.Ponit 1')}} <span class="float-end {{($longTermItem->point_1 >= 0) ? 'text-success' : 'text-danger-emphasis' }}">{{$longTermItem->point_1}}</span></p>
                                    ...
                                    <p class="mt-3 mb-1">{{trans('home.Ponit 2')}} <span class="float-end {{($longTermItem->point_2 >= 0) ? 'text-success' : 'text-danger-emphasis' }}">{{$longTermItem->point_2}}</span></p>
                                    <div class="progress mt-2" style="height: 6px;">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 47%" aria-valuenow="47" aria-valuemin="0" aria-valuemax="47"></div>
                                    </div>

                                    <p class="mt-3 mb-1">{{trans('home.Ponit 3')}} <span class="float-end {{($longTermItem->point_3 >= 0) ? 'text-success' : 'text-danger-emphasis' }}">{{$longTermItem->point_3}}</span></p>
                                    <div class="progress mt-2" style="height: 6px;">
